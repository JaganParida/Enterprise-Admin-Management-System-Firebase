...
const LineChart = ({ data, title }) => {
  ...
  const themeConfig = {
    emerald: {
      ...
      tooltipTitle: "#34d399", // Emerald 400
      tooltipBorder: "rgba(16, 185, 129, 0.2)",
      ticksColor: "rgba(236, 253, 245, 0.5)",
      bgClass: "bg-[#0A0F0D]/60 hover:border-emerald-500/20",
      glowTop: "bg-emerald-500/10",
      glowBottom: "bg-teal-500/5",
    },
    blue: {
      legendColor: "rgba(191, 219, 254, 0.7)", // Light Blue
      tooltipTitle: "#38bdf8", // Blue 400
      tooltipBorder: "rgba(59, 130, 246, 0.2)",
      ticksColor: "rgba(191, 219, 254, 0.5)",
      bgClass: "bg-[#020617]/40 hover:border-blue-500/20 border-blue-500/10",
  ...
  const options = {
    responsive: true,
    maintainAspectRatio: false, // Essential for flex containment
    plugins: {
      legend: {
        position: "top",
        labels: {
